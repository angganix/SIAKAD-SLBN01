(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_Agama_jsx"],{
...
var useForm = function useForm(initForm) {
  ...
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(initForm),
...
var useDelete = function useDelete() {
  var deleteData = function deleteData(id, action, callback) {
    var confirmation = window.confirm('Yakin akan menghapus data ini?');

    if (confirmation) {
      action(id).then(function (status) {
        if (status) {
...
/* harmony import */ var _components_forms_InputGroup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/forms/InputGroup */ "./resources/js/components/forms/InputGroup.jsx");
/* harmony import */ var _components_forms_SubmitButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/forms/SubmitButton */ "./resources/js/components/forms/SubmitButton.jsx");
/* harmony import */ var _components_forms_TableAction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/forms/TableAction */ "./resources/js/components/forms/TableAction.jsx");
/* harmony import */ var _hooks_useCrud__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../hooks/useCrud */ "./resources/js/hooks/useCrud.js");
/* harmony import */ var _services_agama__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/agama */ "./resources/js/services/agama.js");
...
function Agama() {
  var _useForm = (0,_hooks_useCrud__WEBPACK_IMPORTED_MODULE_4__.useForm)(initForm),
      form = _useForm.form,
      loading = _useForm.loading,
      setForm = _useForm.setForm,
      saveForm = _useForm.saveForm;

  var _useList = (0,_hooks_useCrud__WEBPACK_IMPORTED_MODULE_4__.useList)([]),
      list = _useList.list,
      isFetching = _useList.isFetching,
      fetchList = _useList.fetchList;

  var _useDelete = (0,_hooks_useCrud__WEBPACK_IMPORTED_MODULE_4__.useDelete)(),
      deleteData = _useDelete.deleteData;

  var _useEdit = (0,_hooks_useCrud__WEBPACK_IMPORTED_MODULE_4__.useEdit)(),
      editData = _useEdit.editData;

  var agamaInsert = _services_agama__WEBPACK_IMPORTED_MODULE_5__["default"].agamaInsert,
      agamaUpdate = _services_agama__WEBPACK_IMPORTED_MODULE_5__["default"].agamaUpdate,
      agamaList = _services_agama__WEBPACK_IMPORTED_MODULE_5__["default"].agamaList,
      agamaShow = _services_agama__WEBPACK_IMPORTED_MODULE_5__["default"].agamaShow,
      agamaDelete = _services_agama__WEBPACK_IMPORTED_MODULE_5__["default"].agamaDelete;

  var submitHandler = function submitHandler(e) {
    var actionHandler = form.id ? agamaUpdate(form, form.id) : agamaInsert(form);
    saveForm(e, actionHandler, function () {
      fetchList(agamaList());
      setForm(initForm);
    });
  };
  ...
  var deleteHandler = function deleteHandler(id) {
    deleteData(id, agamaDelete, function () {
      fetchList(agamaList());
    });
  };

  var editHandler = function editHandler(id) {
    editData(agamaShow(id), function (data) {
      return setForm(data);
    });
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_bootstrap__WEBPACK_IMPORTED_MODULE_7__["default"], {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_8__["default"], {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["default"], {
        className: "shadow-card border-0 mb-3",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["default"].Body, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_bootstrap__WEBPACK_IMPORTED_MODULE_10__["default"], {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("h4", {
              ...
              className: "separator"
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_forms_InputGroup__WEBPACK_IMPORTED_MODULE_1__["default"], {
              name: "nama",
              id: "nama",
              label: "Nama Agama",
              type: "text",
              value: form.nama,
              onChange: setForm
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_forms_SubmitButton__WEBPACK_IMPORTED_MODULE_2__["default"], {
              loading: loading,
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_bootstrap__WEBPACK_IMPORTED_MODULE_9__["default"].Body, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("h4", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("thead", {
              ...
              children: isFetching ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("tr", {
              ...
              }) : typeof list !== 'undefined' && list.length ? list.map(function (item, idx) {
                return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("tr", {
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("td", {
                    ...
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_forms_TableAction__WEBPACK_IMPORTED_MODULE_3__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Agama);

/***/ }),

/***/ "./resources/js/services/agama.js":
/*!****************************************!*\
  !*** ./resources/js/services/agama.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var services = {
  agamaList: function () {
    var _agamaList = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
      var result;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _utils_api__WEBPACK_IMPORTED_MODULE_1__["default"].get('/agama');
            ...
            case 7:
              ...
              return _context.abrupt("return", Promise.reject(_context.t0.response.data.error));
    ...
    function agamaList() {
      return _agamaList.apply(this, arguments);
    }

    return agamaList;
  }(),
  agamaShow: function () {
    var _agamaShow = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(id) {
      var result;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _utils_api__WEBPACK_IMPORTED_MODULE_1__["default"].get("/agama/".concat(id));
            ...
            case 7:
              ...
              return _context2.abrupt("return", Promise.reject(_context2.t0.response.data.error));
    ...
    function agamaShow(_x) {
      return _agamaShow.apply(this, arguments);
    }

    return agamaShow;
  }(),
  agamaInsert: function () {
    var _agamaInsert = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(form) {
      var result;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _utils_api__WEBPACK_IMPORTED_MODULE_1__["default"].post("/agama", form);

            case 3:
              result = _context3.sent;
              return _context3.abrupt("return", Promise.resolve(result.data.data));

            case 7:
              _context3.prev = 7;
              _context3.t0 = _context3["catch"](0);
              return _context3.abrupt("return", Promise.reject(_context3.t0.response.data.error));
    ...
    function agamaInsert(_x2) {
      return _agamaInsert.apply(this, arguments);
    }

    return agamaInsert;
  }(),
  agamaUpdate: function () {
    var _agamaUpdate = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4(form, id) {
      var result;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return _utils_api__WEBPACK_IMPORTED_MODULE_1__["default"].put("/agama/".concat(id), form);

            case 3:
              result = _context4.sent;
              return _context4.abrupt("return", Promise.resolve(result.data.status));

            case 7:
              _context4.prev = 7;
              _context4.t0 = _context4["catch"](0);
              return _context4.abrupt("return", Promise.reject(_context4.t0.response.data.error));
    ...
    function agamaUpdate(_x3, _x4) {
      return _agamaUpdate.apply(this, arguments);
    }

    return agamaUpdate;
  }(),
  agamaDelete: function () {
    var _agamaDelete = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5(id) {
      var result;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return _utils_api__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/agama/".concat(id));

            case 3:
              result = _context5.sent;
              return _context5.abrupt("return", Promise.resolve(result.data.status));
    ...
    function agamaDelete(_x5) {
      return _agamaDelete.apply(this, arguments);
    }
